...
A lightweight HTTP API server written in Go that serves random aircraft specifications.

## Overview

This service provides a single endpoint that returns a randomly selected aircraft from an internal dataset. It delivers structured JSON data containing the aircraft's name, origin country, speed, operational role, first flight year, and classification type.

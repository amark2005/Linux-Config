...
## Note
You can customize the data to your preferred topic or something you name it.<br>
**Use this as Template to create your own api server**
Host it in Railway or Render.com
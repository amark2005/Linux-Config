...
This api provides a single endpoint that returns a randomly selected aircraft from an internal dataset. It delivers a structured `JSON` formatted data of 
